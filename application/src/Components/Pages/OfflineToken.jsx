            ...
            <div className=" flex flex-col lg:flex-row min-h-screen">
              ...
              <div className="-mt-4 md:-mt-8 flex-1 p-4 md:p-5 overflow-auto">
                ...
                <div className="p-3 md:p-5 md:ps-1 mb-3 md:mb-6">
                  <h1 className="text-2xl font-semibold">Offline token</h1>
                  <div className="pt-2">
                    <div className= "shadow-sm rounded-md py-2 px-2 border-2">
                    <p className="font-normal text-sm">No offline token generated</p>
                  </div>
                  </div>
