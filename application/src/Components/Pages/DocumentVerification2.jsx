                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gray-50">
                      <tr>
                        <th
                          scope="col"
                          className="px-3 md:px-6 py-2 md:py-3 text-left text-sm md:text-xs font-medium text-gray-500 uppercase tracking-wider"
                        >
                          Document Code
                        </th>
                        <th
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      <tr>
                        <td
                          colSpan="5"
                          className="px-3 md:px-6 py-4 whitespace-nowrap text-sm md:text-xs text-gray-500 text-center"
                        >
                          No Data Presented
                        </td>
                      </tr>
