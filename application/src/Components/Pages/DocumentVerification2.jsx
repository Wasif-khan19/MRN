...
const DocumentVerification2 = () => {
                ...
                <div className="flex flex-col sm:gap-4 sm:py-4 sm:pl-14 bg-white">
                    ...
                    <main>
                        <div className=" flex flex-col lg:flex-row min-h-screen">
                            ...
                            <div className="-mt-8 hidden lg:block shadow-md w-auto lg:w-1/5">
    ...
    <div className="md:-mt-8 flex p-2 md:p-3 items-center space-x-2 md:space-x-1 space-y-1 shadow-md w-full">
        <IoIosSettings className="mt-1 md:mt-2" />
        <span><Link className="text-lg md:text-2xl ms-2 font-normal mb-1 md:mb-4">Admin /</Link></span>
        <span className="text-lg md:text-2xl ms-1 font-semibold mb-1 md:mb-4">Identity Verification</span>
    </div>
    ...
    <div className="p-3 md:p-5 md:ps-1 mb-3 md:mb-6">
        <div className="flex flex-col shadow-md p-3 md:p-4 pb-0 ">
            <div className="flex items-center space-x-4 md:space-x-10">
                <Link className="border-b-2 border-gray-800 pb-1 md:pb-2">
                    Supported Document
                </Link>
        ...
        <div className="pt-2 md:pt-3 flex justify-center md:justify-end">
            <button className="bg-blue-500 text-white border border-blue-500 rounded p-2 md:p-3 hover:bg-blue-700 hover:border-blue-700 flex items-center">
    ...
    <div className="bg-white shadow-lg rounded-lg overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
                <tr>
                    <th scope="col" className="px-3 md:px-6 py-2 md:py-3 text-left text-sm md:text-xs font-medium text-gray-500 uppercase tracking-wider">
                        Document Code
                    </th>
                    <th scope="col" className="px-3 md:px-6 py-2 md:py-3 text-left text-sm md:text-xs font-medium text-gray-500 uppercase tracking-wider">
                        Name
            ...
            <tbody className="bg-white divide-y divide-gray-200">
                <tr>
                    <td colSpan="5" className="px-3 md:px-6 py-4 whitespace-nowrap text-sm md:text-xs text-gray-500 text-center">
                        No Data Presented
                    </td>
                </tr>
            </tbody>
        </table>
        <div className="bg-gray-100 mt-2 p-2 md:p-4 rounded-md shadow-inner">
            {/* Content here */}
        </div>
    </div>
</div>
